...
public class Cloud : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < num; i++)
        {
            ...
            Vector3 offset = Random.insideUnitSphere;// Random assign a position
            ...
            scale.y *= 1 - (Mathf.Abs(offset.x) / sphereOffsetScale.x);//Adjust y scale by
